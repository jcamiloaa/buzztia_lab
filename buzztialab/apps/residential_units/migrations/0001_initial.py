# Generated by Django 5.0.12 on 2025-03-01 16:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Updated At')),
                ('tower_label', models.CharField(blank=True, help_text='Optional tower identifier if applicable', max_length=50, null=True, verbose_name='Tower')),
